...
-- res: 1
select * from professor where department like 'informatica';


-- 2. Elenca tutti gli studenti iscritti nell'anno 2021.
-- res: 2
select * from student where subscription_year = 2021;


-- 3. Visualizza tutti i corsi offerti dal dipartimento di Fisica.
-- res: 1
select * from course where department like 'fisica';
